...
import { insertTravelV2RiskBidReviewQueueRecords } from "../helpers/travel-v2-risk-bid-review-queue.js";
...
export class ArcflightTravelEventRunner extends HandlebarsApplicationMixin(ApplicationV2) {
  ...
  #requestTravelV2StationBenefitReview(target) {
    ...
    this.uiState.travelV2StationBenefitUseReviewRequested = Boolean(queueKey);
    this.statusMessage = queueKey
      ? "Station benefit review requested. This only updates local review state and does not apply the benefit."
      : "Station benefit review requires a pending benefit key.";
    return this.render(true);
  }
  ...
  #clearTravelV2SessionSwitchTransientState() {
    ...
    this.uiState.travelV2HazardDrawRequested = false;
    this.uiState.travelV2HazardDrawRequest = null;
    this.uiState.travelV2HazardDrawMode = null;
    this.uiState.travelV2HazardDrawCardId = null;
    this.uiState.travelV2HazardDrawIndex = null;
    this.uiState.travelV2HazardDrawSeed = null;
    this.uiState.travelV2ActiveHazardHandoffReviewRequested = false;
    this.uiState.travelV2ActiveHazardHandoffReviewRequest = null;
    this.uiState.travelV2HazardCandidateControlRequested = false;
    this.uiState.travelV2HazardCandidateControlAction = null;
    this.uiState.travelV2HazardCandidateControlNote = null;
    this.uiState.travelV2ResponseActionResolutionRequested = false;
    this.uiState.travelV2ResponseActionSelectedActionId = null;
    this.uiState.travelV2ResponseActionSelectedHazardCardId = null;
    this.uiState.travelV2ResponseActionResolutionNote = null;
