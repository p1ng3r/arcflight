...
export function runTravelEventRunnerV2PreviewTemplateSmokeChecks() {
  ...
  for (const field of ["actionType", "label", "summary", "source", "reviewOnly", "requiresExplicitGmApply", "eligible", "reason"]) assertIncludes(finalOutcomePreservationApplyPlanTemplate, `{{${field}}}`, `final outcome preservation apply-plan block should render safe field ${field}`);
