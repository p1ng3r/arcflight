...
import { prepareTravelV2RiskBidReviewPreviewPackage } from "../helpers/travel-v2-risk-bid-review-preview.js";
...
export function prepareTravelEventRunnerAppStateWithTravelV2Preview({ session = null, selectedEventId = "", selectedSessionKey = "", actor = null, uiState = {}, travelV2DevToolsEnabled = false, user = globalThis.game?.user } = {}) {
  ...
  const riskBidReviewPreview = prepareTravelV2RiskBidReviewPreviewPackage(session, { canReview: canManageTravelV2Consequences });
