...
export function prepareTravelEventRunnerAppStateWithTravelV2Preview({ session = null, selectedEventId = "", selectedSessionKey = "", actor = null, uiState = {}, travelV2DevToolsEnabled = false, user = globalThis.game?.user } = {}) {
  ...
  const appState = {
    ...
    travelV2RoundActionOrderUnlockResult: uiState.travelV2RoundActionOrderUnlockResult ?? null,
    travelV2RoundActionOrderUnlockPersistResult: uiState.travelV2RoundActionOrderUnlockPersistResult ?? null,
