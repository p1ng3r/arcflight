...
import { prepareTravelEventRunnerState, createTravelEventRunnerSession, prepareTravelV2StationActionLockRunnerUpdate, prepareTravelV2StationActionUnlockRunnerUpdate, persistTravelV2StationActionLockInToRunnerSessionLibrary, loadTravelEventRunnerSessionFromLibrary } from "../helpers/travel-event-runner.js";
...
export async function runTravelEventRunnerV2StationActionLockInSmoke() {
  ...
  return { checked: ["runner state", "ready and not ready", "safe validation messages", "player-safe scan", "GM lock", "GM unlock", "non-GM unlock", "invalid station key", "clone safety", "explicit persistence", "reload", "render no persist", "template controls", "aggregate suite"] };
}
