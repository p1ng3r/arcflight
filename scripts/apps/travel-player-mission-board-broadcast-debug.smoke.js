...
export async function runTravelPlayerMissionBoardBroadcastDebugSmokeChecks() {
  ...
  assertSmoke(arcflightSource.includes("forceTravelStationResult") && arcflightSource.includes("inspectTravelPlayerFlow") && arcflightSource.includes("validateTravelPlayerFlow") && arcflightSource.includes("inspectTravelRoundResolution") && arcflightSource.includes("inspectTravelConsequenceFlow") && arcflightSource.includes("forceTravelRoundResolved") && arcflightSource.includes("forceTravelRoundFinalized") && arcflightSource.includes("dev: { runFoundryChecks, runPlayerSafetyCheck, forceTravelStationResult, inspectTravelPlayerFlow, validateTravelPlayerFlow, inspectTravelRoundResolution, inspectTravelConsequenceFlow, forceTravelRoundResolved, forceTravelRoundFinalized }"), "Travel player-flow dev helpers are exposed through CONFIG.arcflight.dev");
