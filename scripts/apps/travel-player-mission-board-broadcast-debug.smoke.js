...
export async function runTravelPlayerMissionBoardBroadcastDebugSmokeChecks() {
  ...
  assertSmoke(arcflightSource.includes("forceTravelStationResult") && arcflightSource.includes("inspectTravelPlayerFlow") && arcflightSource.includes("validateTravelPlayerFlow") && arcflightSource.includes("inspectTravelRoundResolution") && arcflightSource.includes("inspectTravelConsequenceFlow") && arcflightSource.includes("forceTravelRoundResolved") && arcflightSource.includes("forceTravelRoundFinalized") && arcflightSource.includes("inspectTravelAdvanceRoundFlow") && arcflightSource.includes("inspectTravelEventCompletionFlow") && arcflightSource.includes("forceTravelRoundAdvanced") && arcflightSource.includes("forceTravelEventCompleted") && arcflightSource.includes("dev: { runFoundryChecks, runPlayerSafetyCheck, forceTravelStationResult, inspectTravelPlayerFlow, validateTravelPlayerFlow, inspectTravelRoundResolution, inspectTravelConsequenceFlow, inspectTravelConsequenceApplicationFlow, inspectTravelGmUiFlow, inspectTravelAdvanceRoundFlow, inspectTravelEventCompletionFlow, forceTravelRoundResolved, forceTravelRoundFinalized, forceTravelConsequenceApplied, forceTravelRoundAdvanced, forceTravelEventCompleted }"), "Travel player-flow dev helpers are exposed through CONFIG.arcflight.dev");
