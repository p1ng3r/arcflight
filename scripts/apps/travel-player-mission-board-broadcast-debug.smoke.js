...
export async function runTravelPlayerMissionBoardBroadcastDebugSmokeChecks() {
  ...
  assertSmoke(arcflightSource.includes("forceTravelStationResult") && arcflightSource.includes("inspectTravelPlayerFlow") && arcflightSource.includes("validateTravelPlayerFlow") && arcflightSource.includes("inspectTravelRoundResolution") && arcflightSource.includes("dev: { runFoundryChecks, runPlayerSafetyCheck, forceTravelStationResult, inspectTravelPlayerFlow, validateTravelPlayerFlow, inspectTravelRoundResolution }"), "Travel player-flow dev helpers are exposed through CONFIG.arcflight.dev");
