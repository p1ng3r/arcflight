...
export function sanitizeTravelV2PublicNarration(narration) {
  ...
  return { roundNumber: source.roundNumber, title: source.title, completionState: source.completionState, complete, whatHappened: publicWhatHappened, publicWhatHappened, momentum: publicMomentum, stationVignettes, stationOutcomeBullets: stationVignettes.map((v) => v.publicText), hazardNotes: { revealed: safeHazards }, suggestedReadAloud: publicSuggestedReadAloud, publicSuggestedReadAloud };
}
