...
export function prepareTravelV2InterStationHelpApplicationReview(session = {}, selection = {}, options = {}) {
  ...
  const magnitude = resolved.effectiveMagnitude;
