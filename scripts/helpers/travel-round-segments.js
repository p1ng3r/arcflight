...
export const ARCFLIGHT_TRAVEL_ROUND_SEGMENT_ORDER = Object.freeze([
  ARCFLIGHT_TRAVEL_ROUND_SEGMENTS.CREW_PLANNING,
...
const LEGACY_ROUND_SEGMENT_ALIASES = Object.freeze({
  [ARCFLIGHT_TRAVEL_ROUND_SEGMENTS.ROUND_REVEAL]: ARCFLIGHT_TRAVEL_ROUND_SEGMENTS.CREW_PLANNING,
  [ARCFLIGHT_TRAVEL_ROUND_SEGMENTS.CREW_STRATEGY]: ARCFLIGHT_TRAVEL_ROUND_SEGMENTS.CREW_PLANNING,
  [ARCFLIGHT_TRAVEL_ROUND_SEGMENTS.TABLE_STRATEGY]: ARCFLIGHT_TRAVEL_ROUND_SEGMENTS.CREW_PLANNING,
  [ARCFLIGHT_TRAVEL_ROUND_SEGMENTS.STATION_COMMITMENT]: ARCFLIGHT_TRAVEL_ROUND_SEGMENTS.CREW_PLANNING,
...
export const ARCFLIGHT_TRAVEL_ROUND_SEGMENT_LABELS = Object.freeze({
  [ARCFLIGHT_TRAVEL_ROUND_SEGMENTS.CREW_PLANNING]: "Crew Planning",
...
export const ARCFLIGHT_TRAVEL_ROUND_SEGMENT_GUIDANCE = Object.freeze({
  [ARCFLIGHT_TRAVEL_ROUND_SEGMENTS.CREW_PLANNING]: "The crew reviews all active stations, station actions, Risk Bids, and arranges the current round order before the order is confirmed.",
...
export function normalizeTravelRoundSegmentKey(value) {
  ...
  return LEGACY_ROUND_SEGMENT_ALIASES[value] ?? ARCFLIGHT_TRAVEL_ROUND_SEGMENTS.CREW_PLANNING;
}
