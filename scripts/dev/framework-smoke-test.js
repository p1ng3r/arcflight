...
export async function runFrameworkSmokeTest(options = {}) {
  ...
  try {
    ...
    check(result, "Invalid legacy cleanup helpers exposed", typeof globalThis.game?.arcflight?.findInvalidLegacyArcflightDocuments === "function" && typeof globalThis.game?.arcflight?.cleanupInvalidLegacyArcflightDocuments === "function", true, { findInvalidLegacyArcflightDocuments: typeof globalThis.game?.arcflight?.findInvalidLegacyArcflightDocuments, cleanupInvalidLegacyArcflightDocuments: typeof globalThis.game?.arcflight?.cleanupInvalidLegacyArcflightDocuments });
    check(result, "Invalid legacy cleanup devTools exposed", typeof globalThis.game?.arcflight?.devTools?.findInvalidLegacyArcflightDocuments === "function" && typeof globalThis.game?.arcflight?.devTools?.cleanupInvalidLegacyArcflightDocuments === "function", true, { findInvalidLegacyArcflightDocuments: typeof globalThis.game?.arcflight?.devTools?.findInvalidLegacyArcflightDocuments, cleanupInvalidLegacyArcflightDocuments: typeof globalThis.game?.arcflight?.devTools?.cleanupInvalidLegacyArcflightDocuments });
    const invalidCleanupDryRunReport = await cleanupInvalidLegacyArcflightDocuments({ dryRun: true });
    check(result, "Invalid legacy cleanup dry-run is non-destructive", invalidCleanupDryRunReport.dryRun === true && invalidCleanupDryRunReport.deleted.length === 0 && invalidCleanupDryRunReport.deletionAttempts.length === 0, true, invalidCleanupDryRunReport);
