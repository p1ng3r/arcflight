...
export const LANTERN_IN_THE_STATIC_SAMPLE_EVENT = deepFreeze({
  ...
  finalOutcomes: {
    ...
    mixed: { label: "Free With Fingerprints", vignette: "The crew wins the crossing, but the static leaves a signature behind. A familiar voice may echo once in a quiet corridor, or a ward-lamp may burn blue until the next port of call. Nothing resolves itself automatically; the GM has a living thread to pick up later if it suits the voyage.", proposedEffects: [], rewards: ["Passage secured"], losses: ["Lingering occult unease"], fortuneCandidates: [{ name: "True Bearing Remembered", text: "The true flame briefly reveals a safe bearing the crew may call on later if the GM keeps it." }], rewardCandidates: [{ name: "Rescued Lantern Flame", text: "A contained lantern-flame remains as a narrative boon, not an automatically created item." }], consequenceCandidates: [{ name: "Static Fingerprints", text: "The static left a trace in voice, lamp, or Lifeveil for the GM to resolve later." }] },
    failure: { label: "The Cost Follows", vignette: "The ship gets clear, but only after the parasite takes a keepsake: a copied order, a remembered voice, a sliver of route, or a bruise in the Lifeveil. The crew can breathe again, yet the silence afterward feels borrowed. Somewhere behind them, the lantern burns with a sound almost like laughter.", proposedEffects: [], rewards: ["Escape from the dead stretch"], losses: ["Copied voice or marked wake", "Crew morale shaken"], shipScarCandidates: [{ name: "Echoes in the Rigging", text: "A copied voice or impossible creak may become a ship scar if the GM chooses later." }], consequenceCandidates: [{ name: "Static Fingerprints", text: "The marked wake or copied order remains a manual consequence candidate." }] },
