...
test("station-selection editing API module exposes named helpers", () => {
  ...
  for (const helper of [validateVoyageEncounterRiskBids, applyVoyageEncounterRiskBidSelection, applyVoyageEncounterRiskBidChange, applyVoyageEncounterRiskBidClear]) assert.equal(typeof helper, "function");
