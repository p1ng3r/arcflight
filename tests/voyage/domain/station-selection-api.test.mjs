...
test("station-selection editing API module exposes named helpers", () => {
  ...
  for (const helper of [applyVoyageEncounterPendingCheckResult, prepareVoyageEncounterResolutionCompletion, applyVoyageEncounterConsequencesTransition]) assert.equal(typeof helper, "function");
